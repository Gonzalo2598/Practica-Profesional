        ...
        <section class="content">
          ...
          <div class='col-md-4'>
           ...
           <form class='form-horizontal' id="fupForm" name="form1" method="post">
            ...
            <div class='input-group'>
             <span class='input-group-addon bg-blue'><i class="fa fa-download"></i> Mesas:</span>
             <?Php
            ...
            ?>
             ...
             <div class='input-group'>
             <span class='input-group-addon bg-blue'><i class="fa fa-calendar"></i> Mozo:</span>
             <?Php
              
              $con = new conexion();
              $conn = new mysqli($con->getservername(), $con->getusername(), $con->getpassword(), $con->getdbname());                
              $sql = "SELECT usuario from usuarios where id_user=3";
              $result = $conn->query($sql);
              ?>
          
              <?php
              while($lista=mysqli_fetch_assoc($result))
              echo   "<input type='text' class='form-control' id='mozo' name='mozo'  value='".$lista["usuario"]."'>"; 
              ?>
            ...
            <br>
            <div class='input-group'>
             <span class='input-group-addon  bg-blue'><i class="fa fa-database"></i> Comentario:</span>
             
             <input type="text" class="form-control cantidades" id="impuesto" name="impuesto">
            </div>
            <br>
            <div class='input-group'>
             <span class='input-group-addon  bg-blue'><i class="fa fa-plus"></i> Est. Pedido</span>
...
$(document).ready(function() {
    ...
    var cantidad = $('#cantidad').val();
		if(cliente!="" && mesa!="" && mozo!="" && impuesto!="" && pedido!="" && codigo!="" && descripcion!="" &&  costo!="" && cantidad!=""){
    ...
    <script src="dist/js/source_pedidos.js"></script>
