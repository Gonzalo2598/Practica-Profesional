            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">MESERO</span>
                </a>
                <ul class="dropdown-menu">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pedidos.php"><i class="fa fa-download"></i> Punto de Pedido.</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="lista_clientes_mesero.php"><i class="fa fa-users"></i>  Lista de Clientes.</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              <a href="#"><i class="fa fa-home"></i> <span>Sección Mesas.</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="estados_mesas.php"><i class="fa fa-users"></i> Estados de Mesas.</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="lista_mesero.php"><i class="fa fa-check"></i> Lista de Usuario.</a></li>
              </ul>
            </li>
