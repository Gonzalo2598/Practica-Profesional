            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Cadete</span>
                </a>
                <ul class="dropdown-menu">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="vista_cadete.php"><i class="fa fa-download"></i> Pedidos Pendientes.</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="lista_cadete.php"><i class="fa fa-check"></i> Lista de Usuario.</a></li>
              </ul>
            </li>
