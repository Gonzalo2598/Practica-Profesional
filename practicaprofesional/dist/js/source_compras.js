...
$(document).ready(function(){
    $.ajax({
     ...
     url: 'update_impuesto_compra.php',
     type: 'POST',
...
$(document).ready(function(){
  //alert($("#descuento").val());
    $.ajax({
     ...
     url: 'update_descuento_compra.php',
     type: 'POST',
...
$(document).ready(function(){
    $.ajax({
     ...
     url: 'update_articulos_compras.php',
     type: 'POST',
     data: 'articulo='+art,
     success: function(t){
