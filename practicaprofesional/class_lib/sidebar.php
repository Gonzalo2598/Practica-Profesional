          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="registro_ventas.php"><i class="fa fa-search"></i> Registro de Ventas</a></li>
              </ul>
            </li>

            <li class="treeview">
              <a href="#"><i class="fa fa-home"></i> <span>Clientes.</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="almacen_clientes.php"><i class="fa fa-male"></i> Agregar Cliente.</a></li>
                <li><a href="lista_clientes.php"><i class="fa fa-users"></i>  Lista de Clientes.</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              <a href="#"><i class="fa fa-money"></i> <span>Compras.</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="comprasdearticulos.php"><i class="fa fa-download"></i> Punto de Compra.</a></li>
                <li><a href="registro_compras.php"><i class="fa fa-search"></i> Registro de Compras</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              <a href="#"><i class="fa fa-money"></i> <span>Cajas.</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
